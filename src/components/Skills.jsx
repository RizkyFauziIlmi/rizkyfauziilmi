        ...
        <React.Fragment>
            <VerticalTimeline lineColor='#D6EFED'>
                ...
                >
                    ...
                    <h4>Learn the Basics of Programming and Try to be Familiar with the Syntax</h4>
                    <ClampLines
                ...
                >
                    ...
                    <h4>Explore the Concept of Classes and Objects</h4>
                    <ClampLines
                ...
                <VerticalTimelineElement
                    ...
                    icon={<SiCplusplus />}
                >
                    <h1 style={{ color: 'white', fontWeight: 'bold' }}>C++</h1>
                    <h4>Learn Algorithms to Solve a Problem</h4>                    
                    <ClampLines
                ...
                <VerticalTimelineElement
                    ...
                    icon={<SiHtml5 />}
                >
                    <h1 style={{ color: 'white', fontWeight: 'bold' }}>HTML</h1>
                    <h4>Getting Interested in Web Development</h4>
                    <ClampLines
                ...
                <VerticalTimelineElement
                    ...
                    icon={<FaCss3 />}
                >
                    <h1 style={{ color: 'white', fontWeight: 'bold' }}>CSS</h1>
                    <h4>Learn How to Decorate the Page to Make it More Attractive</h4>
                    <ClampLines
                ...
                <VerticalTimelineElement
                    ...
                    icon={<FaJs />}
                >
                    <h1 style={{ color: '#343A40', fontWeight: 'bold' }}>Javascript</h1>
                    <h4>Make the Page More Interactive, and Get to Know Something Very Powerful</h4>
                    <ClampLines
                ...
                <VerticalTimelineElement
                    ...
                    icon={<SiPhp />}
                >
                    <h1 style={{ color: '#343A40', fontWeight: 'bold' }}>PHP</h1>
                    <h4>Know More About Back End</h4>
                    <ClampLines
